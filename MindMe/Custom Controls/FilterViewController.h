...
@property (weak, nonatomic) IBOutlet UILabel *selectCareTypeStaticLabel;
@property (weak, nonatomic) IBOutlet UILabel *distanceStaticLabel;
@property (weak, nonatomic) IBOutlet UILabel *yearsOfExStaticLabel;
