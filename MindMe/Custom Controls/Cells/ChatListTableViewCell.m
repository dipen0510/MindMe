...
- (void) setupInitialUI {
    ...
    _titleLabel.font = [UIFont fontWithName:@"Montserrat-SemiBold" size:(17./667)*kScreenHeight];
    _descriptionLabel.font = [UIFont fontWithName:@"Montserrat-Light" size:(15./667)*kScreenHeight];
    _dateLabel.font = [UIFont fontWithName:@"Montserrat-Light" size:(12./667)*kScreenHeight];
