...
- (void) setupInitialUI {
    ...
    _goldMonthlyLabel.font = _goldAnnualLabel.font = _goldQuarterlyLabel.font = _silverMonthlyLabel.font = _silverQuarterlyLabel.font = _silverAnnualLabel.font = [UIFont fontWithName:@"Montserrat-Medium" size:(17.5/667)*kScreenHeight];
    
    _goldMonthlyStaticLabel.font = _goldAnnualStaticLabel.font = _goldQuarterlyStaticLabel.font = _silverMonthlyStaticLabel.font = _silverQuarterlyStaticLabel.font = _silverAnnualStaticLabel.font = [UIFont fontWithName:@"Montserrat-Light" size:(17.5/667)*kScreenHeight];
