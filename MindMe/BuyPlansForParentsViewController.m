...
- (void) setupInitialUI {
    ...
    _goldStaticLabel.font = _silverStaticLabel.font = [UIFont fontWithName:@"Montserrat-SemiBold" size:(22.5/667)*kScreenHeight];
    ...
    _voucherApplyButton.titleLabel.font = _goldMonthlySelectButton.titleLabel.font = _goldQuarterlySelectButton.titleLabel.font = _goldYearlySelectButton.titleLabel.font = _silverMonthlySelectButton.titleLabel.font = _silverQuarterlySelectButton.titleLabel.font = _silverYearlySelectButton.titleLabel.font = [UIFont fontWithName:@"Montserrat-Regular" size:(19./667)*kScreenHeight];
    
    _goldMonthlyLabel.font = _goldAnnualLabel.font = _goldQuarterlyLabel.font = _silverMonthlyLabel.font = _silverQuarterlyLabel.font = _silverAnnualLabel.font = [UIFont fontWithName:@"Montserrat-Medium" size:(20./667)*kScreenHeight];
    
    _goldMonthlyStaticLabel.font = _goldAnnualStaticLabel.font = _goldQuarterlyStaticLabel.font = _silverMonthlyStaticLabel.font = _silverQuarterlyStaticLabel.font = _silverAnnualStaticLabel.font = [UIFont fontWithName:@"Montserrat-Light" size:(20./667)*kScreenHeight];
    
    _infoLabel1.font = _infoLabel2.font =  [UIFont fontWithName:@"Montserrat-Light" size:(16./667)*kScreenHeight];
